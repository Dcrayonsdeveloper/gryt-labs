...
Route::prefix('v1')->name('api.v1.')->group(function () {
    ...
    // Public routes (open — search, suggestions, pages, settings)

    // API-key protected routes (for third-party integrations like Shiprocket)
    Route::middleware(\App\Http\Middleware\VerifyApiKey::class)->group(function () {
        ...
        Route::prefix('categories')->name('categories.')->group(function () {
            ...
            Route::get('products', [\App\Http\Controllers\Api\V1\Category\CategoryController::class, 'products'])->name('collection-products');
