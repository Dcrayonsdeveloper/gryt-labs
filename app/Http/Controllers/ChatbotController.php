...
class ChatbotController extends Controller
{
    ...
    {
        $storeName = Setting::get('site_name', config('app.name', 'Store'));
        ...
        $prompt .= $freeShippingThreshold
            ? "- **Shipping**: Free on orders above ₹{$freeShippingThreshold}. Standard delivery in 3–7 business days. Express delivery available at checkout for select cities.\n"
            : "- **Shipping**: Standard delivery in 3–7 business days. Express delivery available at checkout for select cities.\n";
