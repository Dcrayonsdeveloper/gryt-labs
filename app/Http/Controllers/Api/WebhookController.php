...
class WebhookController extends Controller
{
    ...
    public function verify(Request $request): Response
    {
        ...
        // Per-tenant verify token (Settings), fall back to global .env for single-tenant setups
        $verifyToken = Setting::get('meta_verify_token', '') ?: config('services.meta.verify_token');
