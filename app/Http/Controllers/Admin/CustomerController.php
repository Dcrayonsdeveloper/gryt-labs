...
class CustomerController extends Controller
{
    ...
    public function updateTags(Request $request, User $customer): RedirectResponse
    {
        abort_if(!in_array($customer->role, ['customer', 'delivery_partner']), 404);

        $validated = $request->validate([
            'admin_tags' => 'nullable|array|max:20',
            'admin_tags.*' => 'string|max:40',
        ]);

        $tags = collect($validated['admin_tags'] ?? [])
