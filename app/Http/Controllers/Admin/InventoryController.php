...
class InventoryController extends Controller
{
    public function index(Request $request): View
    {
        ...
        $query = Product::select('id', 'name', 'slug', 'sku', 'stock_quantity', 'low_stock_threshold');
    ...
    public function updateStock(Request $request, Product $product): RedirectResponse
    {
        ...
        // Sync stock_status (increment/decrement bypass model events)
        $product->refresh();
        $newStatus = $product->stock_quantity > 0 ? 'in_stock' : 'out_of_stock';
