                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <div class="flex flex-col gap-2" data-sticky-trigger>
                            <button x-data="{ adding: false, added: false }"
                                    ...
                                    :disabled="adding"
                                    class="w-full flex items-center justify-center gap-2 bg-accent-500 hover:bg-accent-600 text-white font-semibold py-2.5 rounded-full text-sm transition-colors disabled:opacity-70">
