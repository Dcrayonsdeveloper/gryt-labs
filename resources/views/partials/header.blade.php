    ...
    <div class="text-neutral-900 py-1.5 text-[11px] sm:text-xs font-medium tracking-wide" style="background-color:#B8DC24;">
        <div class="container mx-auto px-4 flex items-center justify-between">
            ...
            <div class="hidden sm:flex items-center gap-3">
                ...
                @endphp
                @if($headerPhone)
                <a href="tel:{{ preg_replace('/[^0-9+]/', '', (string) $headerPhone) }}" class="inline-flex items-center gap-1 text-neutral-800 hover:text-black transition">
                ...
                <a href="{{ url('/about-us') }}" class="text-neutral-800 hover:text-black transition">About Us</a>
                <a href="{{ url('/contact') }}" class="text-neutral-800 hover:text-black transition">Contact</a>
            </div>
        </div>
    </div>
    @endif
