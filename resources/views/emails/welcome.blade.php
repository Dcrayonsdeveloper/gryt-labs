...
# Welcome to {{ \App\Models\Setting::get('store_name', config('app.name')) }}!

Hi {{ $user->first_name }},

We are thrilled to have you join the {{ \App\Models\Setting::get('store_name', config('app.name')) }} family! Thank you for creating your account with us.

Thank you for creating your account with us. We look forward to serving you!
...
- **Easy Returns** -- Hassle-free returns within {{ \App\Models\Setting::get('return_policy_days', 7) }} days of delivery
