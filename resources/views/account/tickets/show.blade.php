        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="bg-white border border-neutral-100 rounded-xl mb-4">
                    ...
                    <div class="p-5">
                        <div class="flex items-start gap-3">
                            <div class="w-8 h-8 bg-primary-600/10 rounded-full flex items-center justify-center shrink-0">
                                <span class="text-xs font-semibold text-primary-600">{{ strtoupper(substr(auth()->user()->first_name, 0, 1)) }}</span>
                            </div>
                            <div class="flex-1 min-w-0">
                ...
                @foreach($ticket->replies as $reply)
                    <div class="bg-white border border-neutral-100 rounded-xl mb-4 {{ $reply->is_admin ? 'border-l-4 border-l-primary-600' : '' }}">
                        <div class="p-5">
                            <div class="flex items-start gap-3">
                                <div class="w-8 h-8 rounded-full flex items-center justify-center shrink-0 {{ $reply->is_admin ? 'bg-accent-500' : 'bg-primary-600/10' }}">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center gap-2 mb-1">
                                        ...
                                        @if($reply->is_admin)
                                            <span class="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-medium bg-primary-600/10 text-primary-700">Staff</span>
                                        @endif
                    ...
                    <div class="bg-white border border-neutral-100 rounded-xl">
                        ...
                        <form action="{{ route('account.tickets.reply', $ticket) }}" method="POST" class="p-5">
                            ...
                            <div class="mt-3 flex justify-end">
                                <button type="submit"
                                        class="px-3 py-1.5 bg-accent-500 text-white text-sm font-semibold rounded-lg hover:bg-accent-600 transition-colors">
                                    Send Reply
                                </button>
                            </div>
                        </form>
