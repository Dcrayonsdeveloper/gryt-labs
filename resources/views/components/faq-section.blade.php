...
@php
    ...
    $faqPool = [
        ...
        ['q' => "Is {$productName} genuine and authentic?", 'a' => "Absolutely. {$productName} is manufactured for {$storeName} by genuine manufacturers and comes with a quality guarantee."],
        ...
        ['q' => "Does {$productName} come with a warranty?", 'a' => "Our brand does not provide any warranty or guarantee, and {$productName} is not intended to cure any illness or medical condition. Please consult a health professional for any questions or before taking supplements."],
