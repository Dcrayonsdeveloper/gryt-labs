        ...
        <div class="container mx-auto px-4 py-10">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-[14px] text-neutral-600">{{ $message ?? 'Your payment could not be processed. No amount has been charged.' }}</p>
                </div>
                ...
                <div class="bg-white rounded-xl border border-neutral-100 p-5 mb-6">
                    ...
                    <ul class="space-y-2 text-sm text-neutral-600">
                        ...
                        <li class="flex items-start gap-2">
                            ...
                            If any amount was deducted, it will be refunded within {{ $theme->get('refund_processing_days', '5-7') }} business days.
                        </li>
                    </ul>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <a href="{{ route('checkout.index') }}"
                       class="flex-1 inline-flex items-center justify-center gap-2 py-2 px-4 bg-[var(--color-primary-700)] hover:bg-[var(--brand-800)] text-white text-sm font-semibold rounded-xl transition-colors">
                ...
                <div class="mt-8 text-center">
                    <p class="text-xs text-neutral-600">
                        Need help? <a href="{{ route('contact') }}" class="text-[var(--color-primary-600)] hover:underline">Contact our support team</a>
                    </p>
                </div>
