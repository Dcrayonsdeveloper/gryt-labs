<x-layouts.app>
    ...
    @push('meta')
        <meta name="description" content="Shipping information for {{ config('app.name') }}. Learn about delivery times, shipping costs, and tracking your orders.">
    ...
    @php
        ...
        $sameDayCutoff = $theme->get('same_day_cutoff', '12 PM');
        $sameDayCities = $theme->get('same_day_cities', 'Select cities');
        $codMaxOrder = $theme->get('cod_max_order', 5000);
        $orderCutoff = $theme->get('order_processing_cutoff', '2:00 PM IST');
    ...
    <div class="container mx-auto px-4 py-8 sm:py-12">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="text-center mb-8 sm:mb-10">
                <div class="w-14 h-14 mx-auto rounded-full bg-primary-600/5 flex items-center justify-center mb-4">
            ...
            <div class="mb-8">
                <p class="text-xs font-semibold text-primary-600 uppercase tracking-wider pb-3">Delivery Options</p>
                    ...
                    <div class="bg-white border border-neutral-100 rounded-xl p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-neutral-600 mt-0.5">{{ $standardDays }} business days</p>
                                <p class="text-sm font-bold text-primary-600 mt-1.5">FREE on orders above {{ $cs }}{{ $freeShipThreshold }}</p>
                                <p class="text-[11px] text-neutral-600 mt-0.5">{{ $cs }}{{ $flatRate }} for orders below {{ $cs }}{{ $freeShipThreshold }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white border border-neutral-100 rounded-xl p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-[11px] text-neutral-600 mt-0.5">On orders up to {{ $cs }}{{ number_format($codMaxOrder) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div x-data="{ open: null }" class="space-y-3">
                ...
                <p class="text-xs font-semibold text-primary-600 uppercase tracking-wider pt-2 pb-1">Order Processing</p>
                ...
                <div class="bg-white border border-neutral-100 rounded-xl overflow-hidden">
                    ...
                    <div x-show="open === 1" x-collapse>
                        <div class="px-5 pb-4 text-[13px] text-neutral-600 leading-relaxed border-t border-neutral-50">
                            <p class="pt-3">Orders placed before {{ $orderCutoff }} on business days are typically processed and shipped the same day. Orders placed after {{ $orderCutoff }} or on weekends/holidays will be processed the next business day.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div x-show="open === 2" x-collapse>
                        <div class="px-5 pb-4 text-[13px] text-neutral-600 leading-relaxed border-t border-neutral-50">
                            ...
                            <ul class="mt-2 space-y-1 list-disc list-inside text-neutral-600">
                                ...
                                <li>Use our <a href="{{ route('track-order') }}" class="text-primary-600 hover:text-primary-700 font-medium">order tracking page</a></li>
                ...
                <p class="text-xs font-semibold text-primary-600 uppercase tracking-wider pt-4 pb-1">Delivery Details</p>
                ...
                <p class="text-xs font-semibold text-primary-600 uppercase tracking-wider pt-4 pb-1">Issues & Support</p>
                ...
                <div class="bg-white border border-neutral-100 rounded-xl overflow-hidden">
                    ...
                    <div x-show="open === 6" x-collapse>
                        <div class="px-5 pb-4 text-[13px] text-neutral-600 leading-relaxed border-t border-neutral-50">
                            <p class="pt-3">If your package arrives damaged or is lost in transit, please contact us within {{ $returnDays }} days of the expected delivery date. We will work with the delivery partner to resolve the issue and arrange a replacement or refund as quickly as possible.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-10 bg-white border border-neutral-100 rounded-xl p-6 sm:p-8 text-center">
                <div class="w-11 h-11 mx-auto rounded-full bg-primary-600/5 flex items-center justify-center mb-3">
                ...
                <a href="{{ route('contact') }}"
                   class="inline-flex items-center px-4 py-2 bg-accent-500 hover:bg-accent-600 text-white text-sm font-semibold rounded-xl transition-colors">
                    Contact Support
                </a>
            </div>
        </div>
