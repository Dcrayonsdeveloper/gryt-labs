    ...
    <section class="py-10 sm:py-14">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <!-- Header -->
                <div class="mb-10">
                    <h1 class="text-2xl sm:text-3xl font-bold text-neutral-900 mb-3">Careers at {{ \App\Models\Setting::get('store_name', config('app.name')) }}</h1>
                    <p class="text-sm text-neutral-600 max-w-lg mx-auto">Join our team and help us bring the best products to customers across India.</p>
                </div>

                <!-- No Openings Card -->
                <div class="bg-white rounded-xl border border-neutral-100 p-8 sm:p-12">
                    <div class="w-16 h-16 mx-auto rounded-full bg-primary-600/10 flex items-center justify-center mb-5">
                    ...
                    <div class="inline-flex items-center gap-2 bg-neutral-50 rounded-lg px-5 py-3 border border-neutral-100">
                        ...
                        @php $careerEmail = \App\Models\Setting::get('contact_email', 'careers@example.com'); @endphp
                        <a href="mailto:{{ $careerEmail }}" class="text-sm font-medium text-primary-600 hover:underline">{{ $careerEmail }}</a>
                    </div>
                </div>
                ...
                <div class="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-6 text-left">
                    <div class="bg-white rounded-xl border border-neutral-100 p-5">
                        <div class="w-9 h-9 rounded-lg bg-accent-500/10 flex items-center justify-center mb-3">
                        ...
                        <p class="text-xs text-neutral-600 leading-relaxed">Be part of a rapidly growing e-commerce brand with big ambitions.</p>
                    </div>
                    <div class="bg-white rounded-xl border border-neutral-100 p-5">
                        <div class="w-9 h-9 rounded-lg bg-primary-600/10 flex items-center justify-center mb-3">
                    ...
                    <div class="bg-white rounded-xl border border-neutral-100 p-5">
                        ...
                        <p class="text-xs text-neutral-600 leading-relaxed">Help bring quality, affordable products to customers across India.</p>
                    </div>
                </div>
