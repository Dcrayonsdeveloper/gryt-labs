        ...
        $faqSchema = [
            ...
            'mainEntity' => [
                ...
                [
                    ...
                    'acceptedAnswer' => [
                        '@type' => 'Answer',
                        'text' => 'To request a refund, log into your account, go to your Orders, and select the order you wish to return. Click Request Return and follow the instructions. Once we receive and inspect the returned item, your refund will be processed within ' . $refundDays . ' business days.',
                    ],
                ],
                [
                    '@type' => 'Question',
    ...
    <div class="container mx-auto px-4 py-8 sm:py-12">
        <div class="max-w-3xl mx-auto">
            ...
            <div x-data="{ open: null }" class="space-y-3">
                ...
                <!-- Section: Ordering -->
                <p class="text-xs font-semibold text-primary-600 uppercase tracking-wider pt-2 pb-1">Ordering</p>
                ...
                <div class="bg-white border border-neutral-100 rounded-xl overflow-hidden">
                    ...
                    <div x-show="open === 3" x-collapse>
                        <div class="px-5 pb-4 text-[13px] text-neutral-600 leading-relaxed border-t border-neutral-50">
                            <p class="pt-3">Once your order ships, you'll receive an email with tracking information. You can also track your order by logging into your account and visiting the Orders section, or by using our <a href="{{ route('track-order') }}" class="text-primary-600 hover:text-primary-700 font-medium">order tracking page</a>.</p>
                        </div>
                    </div>
                </div>

                <!-- Section: Shipping -->
                <p class="text-xs font-semibold text-primary-600 uppercase tracking-wider pt-4 pb-1">Shipping</p>
                ...
                <p class="text-xs font-semibold text-primary-600 uppercase tracking-wider pt-4 pb-1">Returns & Refunds</p>
                ...
                <div class="bg-white border border-neutral-100 rounded-xl overflow-hidden">
                    ...
                    <div x-show="open === 7" x-collapse>
                        <div class="px-5 pb-4 text-[13px] text-neutral-600 leading-relaxed border-t border-neutral-50">
                            <p class="pt-3">To request a refund, log into your account, go to your Orders, and select the order you wish to return. Click "Request Return" and follow the instructions. Once we receive and inspect the returned item, your refund will be processed within {{ $refundDays }} business days.</p>
                        </div>
                    </div>
                </div>

                <!-- Section: Account -->
                <p class="text-xs font-semibold text-primary-600 uppercase tracking-wider pt-4 pb-1">Account</p>
