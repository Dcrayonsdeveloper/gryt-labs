<x-layouts.app>
    ...
    <div class="container mx-auto px-4 py-8 sm:py-12">
        <div class="max-w-3xl mx-auto">
            ...
            {{-- Children notice --}}
            <div class="bg-primary-600/5 border border-primary-600/20 rounded-xl p-5 sm:p-6 mb-4">
                <div class="flex items-start gap-3">
                    <div class="w-9 h-9 bg-primary-600/10 rounded-lg flex items-center justify-center shrink-0">
            ...
            {{-- Data Controller --}}
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 mb-4">
                <h2 class="text-[15px] font-bold text-neutral-900 mb-2">Data Controller</h2>
                <p class="text-[13px] text-neutral-600 leading-relaxed">
                    The data controller responsible for your personal data is <strong>{{ \App\Models\Setting::get('legal_name', config('app.name')) }}</strong> (operating as "{{ \App\Models\Setting::get('site_name', config('app.name')) }}")@if(\App\Models\Setting::get('company_address')), located at {{ \App\Models\Setting::get('company_address') }}@endif. @if(\App\Models\Setting::get('company_gstin'))GSTIN: {{ \App\Models\Setting::get('company_gstin') }}.@endif
                </p>
            </div>
            ...
            <div class="bg-white border border-neutral-100 rounded-xl p-5 sm:p-6 text-center">
                ...
                <p class="text-[13px] text-neutral-600 mb-4">If you have any questions or want to exercise your rights, contact {{ \App\Models\Setting::get('legal_name', config('app.name')) }} and we will respond promptly.</p>
