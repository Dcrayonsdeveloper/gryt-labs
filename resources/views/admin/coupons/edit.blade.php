<x-layouts.admin>
    ...
    <form action="{{ route('admin.coupons.update', $coupon) }}" method="POST">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                        ...
                        <div class="border-t border-neutral-100 pt-4">
                            <label class="flex items-center gap-3 cursor-pointer">
                                ...
                                <input type="checkbox" name="is_stackable" value="1" id="is_stackable"
                                       class="rounded border-neutral-300 text-primary-600 focus:ring-primary-500"
                                       @checked(old('is_stackable', $coupon->is_stackable))>
                                <div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h2 class="font-semibold text-neutral-900">Analytics</h2>
                    </div>
                    <div class="p-4 space-y-2.5 text-sm">
                        <div class="flex items-center justify-between">
                            <span class="text-neutral-600">Total Uses (paid)</span>
                            <span class="font-semibold text-neutral-800">{{ number_format($couponStats->total_uses) }}</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-neutral-600">Last 30 Days</span>
                            <span class="font-semibold text-neutral-800">{{ number_format($usageLast30) }}</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-neutral-600">Total Revenue</span>
                            <span class="font-semibold text-neutral-800">@price($couponStats->total_revenue)</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-neutral-600">Avg Order Value</span>
                            <span class="font-semibold text-neutral-800">@price(round($couponStats->avg_order_value, 2))</span>
                        </div>
                    </div>
                </div>
    ...
    {{-- Delete (must be outside the update form) --}}
