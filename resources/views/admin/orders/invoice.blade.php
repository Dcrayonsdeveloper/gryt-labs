    ...
    <div class="invoice">
        ...
        <div class="header">
            <div class="header-left">
                <img src="{{ asset(\App\Models\Setting::get('store_logo', 'images/logo.png')) }}" alt="{{ \App\Models\Setting::get('store_name', config('app.name')) }}" height="55" style="flex-shrink: 0;">
                <div>
            ...
            <div class="header-right">
                <div class="header-meta">
                    <strong>{{ \App\Models\Setting::get('legal_name', config('app.name')) }}</strong><br>
        ...
        <div class="meta-bar">
            ...
            <div class="meta-item">
                ...
                <div class="meta-value">{{ $order->currency ?? (\App\Models\Setting::get('currency', '') ?: config('app.currency', 'INR')) }}</div>
            </div>
        </div>
        ...
        {{-- Footer --}}
        <div class="footer">
            <div class="footer-thanks">Thank you for shopping with {{ \App\Models\Setting::get('store_name', config('app.name')) }}!</div>
