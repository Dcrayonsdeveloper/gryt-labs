<form action="{{ route('products.index') }}" method="GET" class="space-y-4">
    ...
    <div class="flex gap-2 pt-2">
        ...
        <a href="{{ route('products.index') }}" class="flex-1 py-2.5 text-center text-sm font-medium text-neutral-600 rounded-lg hover:bg-neutral-50 border border-neutral-200 transition-colors">
            Reset
        </a>
    </div>
</form>
