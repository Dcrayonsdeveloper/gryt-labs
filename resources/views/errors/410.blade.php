...
<head>
    ...
    <title>This Page Has Been Removed - {{ config('app.name') }}</title>
...
<body>
    ...
    <div class="content">
        <div class="card">
            ...
            <h1 class="title">This Page Has Been Removed</h1>
            <p class="message">Oops! The page you're looking for doesn't exist or has been moved. Try searching or browse our products.</p>

            {{-- Search --}}
            <form action="{{ url('/search') }}" method="GET" style="margin-bottom:1.5rem;display:flex;gap:0.5rem;max-width:24rem;margin-left:auto;margin-right:auto">
