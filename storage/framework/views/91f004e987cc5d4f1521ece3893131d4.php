        ...
        <div class="px-4 py-3 border-b border-neutral-100 shrink-0">
            <?php if(auth()->guard()->guest()): ?>
                <div class="flex gap-2">
                    <a href="<?php echo e(route('login')); ?>" class="flex-1 py-2 text-center text-sm font-semibold text-white bg-accent-500 hover:bg-accent-600 rounded-lg transition-colors">Login</a>
