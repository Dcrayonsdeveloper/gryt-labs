    ...
    <div class="card">
        ...
        <form method="POST" action="<?php echo e(route('admin.login')); ?>">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" id="email" value="<?php echo e(old('email')); ?>" required autofocus placeholder="Enter your email">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="back-link">
        <a href="<?php echo e(url('/')); ?>">&larr; Back to <?php echo e(config('app.name')); ?></a>
    </div>
...
<?php /**PATH D:\projects\grytlabs345\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>