...
<div x-data="{ open: false, pulse: true }"
     ...
     class="fixed bottom-[4.5rem] sm:bottom-6 left-4 sm:left-6 z-50 flex flex-col items-center gap-3">
    ...
    <div x-show="open" x-cloak
        ...
        <div class="flex items-center gap-3 mb-3">
            ...
            <div>
                <p class="text-sm font-semibold text-gray-900">Chat with <?php echo e($theme->get('store_name', config('app.name'))); ?></p>
